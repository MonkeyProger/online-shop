...
public class OnlineShopApplication {
	...
	CommandLineRunner run(UserDetailsServiceImpl userDetailsService,
		...
		return args -> {
			...
			stockService.saveProduct(new Product(null, "Iphone14","Смартфон Apple IPhone 14",null, 50.50f,null, 100, null, null, null));
			stockService.saveProduct(new Product(null, "Iphone13","Смартфон Apple IPhone 13",null, 25.25f,null, 4, null, null, null));
			stockService.saveProduct(new Product(null,"SamsungGS8","Смартфон Samsung Galaxy S8",null,25f,null,200, null, null, null));
			stockService.saveProduct(new Product(null,"HuaweiP50","Смартфон Huawei P50",null,23f,null,200,null, null, null));
			stockService.saveProduct(new Product(null,"AppleAirPodsPro","Наушники Apple AirPods Pro",null,15f,null,200,null,null, null));
			stockService.saveProduct(new Product(null,"CaseHuaweiP50","Наушники Apple AirPods Pro",null,15f,null,200,null,null, null));
			stockService.saveProduct(new Product(null,"YandexStation","Умная колонка Яндекс Станция",null,20f,null,200,null,null, null));
