...
public class StockController {
    ...
    public ResponseEntity<?> getProductsByCategory(@PathVariable String category) {
        ...
        return ResponseEntity.ok().body(ProductMapping.listToDTO(products));
    }

    @GetMapping("/allCategories")
    public ResponseEntity<?> getAllCategories() {
        List<Category> categories = stockService.getAllCategories();
        return ResponseEntity.ok().body(CategoryMapping.listToDTO(categories));
    }
